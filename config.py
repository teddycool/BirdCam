...
birdcam = { "Debug": True,
            ...
            "Recorder": {"VideoFileDir": "/ram/videos/", "VideoFile":"/home/pi/BirdCam/video.avi", "tempfile": "/ram/videos/", "MinSize": 70000, "MaxFrames": 600},
            "Logger": {"LogFile": "/home/pi/BirdCam/Logger/log.txt"},
            "IrLigth": {"ControlPins":[26,19,13,6,5], "StartFreq": 100},
            ...
            "Server" : {"Active": False, "ConnectionString": "sudo mount -t cifs //192.168.10.3/web /mnt/ubuntu -o user=psk,pass=elinsu,dom=EV39",
                        "MntPoint": "/mnt/ubuntu", "subdir": "/videos/","MinSizeToCopy": 70000}
                }
